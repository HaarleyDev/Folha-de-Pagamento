...
<body>
    <div class="container">
        <div class="sitemap">
            <a href="../../admin.php">Tela inicial</a> > <a href="../../funcionario/relatorio_a.php">Relatório por funcionario</a> > <a href="#">Relatório anual do funcionario</a>
        </div>
        <h1>Relatório Anual do funcionario</h1>
        <table>
            <thead>
                <tr>
                ...
                $sql = "SELECT f.nome, p.trabalhadas_h, p.valor_h, p.data_p, p.salario_l,p.IR,p.FGTS,p.INSS from pag as p, func as f WHERE p.id_f = '$func_anual' and f.id_f = p.id_f";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "</tr>";
                        // echo "<h3>Valor total: $soma_total";
                    }
                } else {
                    echo "<tr><td>Ainda não possui pagamento</td></tr>";
                }
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a class="btn" href="../../funcionario/relatorio_a.php">Voltar</a>

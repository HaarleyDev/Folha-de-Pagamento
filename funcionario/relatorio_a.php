...
<head>
    ...
    <title>Relatorio por funcionario</title>
</head>
<style>
    body {
...
<body>
    <div class="container">
        <div class="sitemap">
            <a href="../admin.php">Tela inicial</a> > <a href="#">Relatório por funcionario</a>
        </div>
        <h1>Selecione o funcionario</h1>
        <form action="../back/relatorios/relatorio_a.php" method="POST">
            <label>Nome do funcionario </label>
            <select name="func_anual" required>
                ...
                if ($result->num_rows) {
                    while ($linha = $result->fetch_assoc()) {
                        echo "<option value=" . $linha['id_f'] . ">" . $linha['nome'] . "</option>";
                    }
                } else {
